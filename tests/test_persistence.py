...
from kalshi_bot.models import Fill, Side
...
class TestSaveState:
    ...
    def test_positions_saved(self, tmp_state_file):
        ...
        assert data["positions"][0]["ticker"] == "T"
...
class TestRoundtrip:
    def test_full_roundtrip(self, tmp_state_file):
        ...
        p.record_fill(Fill(ticker="A", side=Side.YES, price=Decimal("0.70"), quantity=20))
        p.record_fill(Fill(ticker="B", side=Side.NO, price=Decimal("0.40"), quantity=15))
